<?php get_header( 'buddypress' ); ?>
	...
	<div id="header-bottom">
		...
		<div id="page-title"><span><?php if ( bp_has_groups() ) : while ( bp_groups() ) : bp_the_group(); ?><?php bp_group_name(); ?><?php endwhile; endif; ?></span></div>
	...
	<a href="<?php echo home_url(); ?>"><?php echo of_get_option('t-5', 'Home' ); ?></a> &nbsp;&raquo;&nbsp; <a href="<?php echo home_url(); ?>/<?php echo of_get_option('t-14', 'groups' ); ?>"><?php echo of_get_option('t-13', 'Groups' ); ?></a> &nbsp;&raquo;&nbsp; <?php if ( bp_has_groups() ) : while ( bp_groups() ) : bp_the_group(); ?><?php bp_group_name(); ?><?php endwhile; endif; ?>
	</div>
	</div><!-- #frontpage-info -->
