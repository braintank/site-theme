<?php get_header( 'buddypress' ); ?>
	...
	<div id="header-bottom">
		...
		<div id="page-title"><span><?php _e( 'Create an Account', 'buddypress' ); ?></span></div>
	...
	<a href="<?php echo home_url(); ?>"><?php echo of_get_option('t-5', 'Home' ); ?></a> &nbsp;&raquo;&nbsp; <?php _e( 'Create an Account', 'buddypress' ); ?>
	</div>
	</div><!-- #frontpage-info -->
